...
unsigned int THE_CHANGE = 173774;

map<uint256, CBlockIndex*> mapBlockIndex;
uint256 hashGenesisBlock("0x5706e2c132a4b9362656fe56568324a9035f540a361f77cadce7af4a55e4b0c8");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // MagicInternetMoney: starting difficulty is 1 / 2^12
...
{
    // MagicInternetMoney: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
	...
	static int64 nTargetSpacing = 1 * 60; // MagicInternetMoney: 1 minutes
...
unsigned int static GetNextWorkRequired_V1(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // MagicInternetMoney: This fixes an issue where a 51% attack can change difficulty at will.
...
{
        static const int64 BlocksTargetSpacing = 0.5 * 60; // 60 seconds
...
bool CBlock::CheckBlock(CValidationState &state, int nHeight, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // MagicInternetMoney: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // MagicInternetMoney: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xd1713ed1ba3cbd35ada39c6bbd29737ea82f1657a2b95582c0debf4a387fccb9");
    }
...
//  vMerkleTree: 504710ad02a6e55ca55b03de91832e56f5e3a844577bd6061263d6bcab26e21e 
 ...
 // Genesis block
        ...
        block.nVersion = 1;
        block.nTime    = 1392144119;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2024049;

        if (fTestNet)
        {
            block.nTime    = 1392144019;
            block.nNonce   = 1109709;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x552d1bd644091e0689a5f19d20ccb9c173bc087a64b045fc103a5d2a38797bb3"));
        block.print();
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    if (auxpow != NULL) {
        ...
        //// debug print
        printf("MagicInternetMoneyMiner:\n");
...
void static ScryptMiner(CWallet *pwallet)
{
    ...
    RenameThread("magicinternetmoney-miner");
