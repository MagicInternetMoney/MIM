...
static const char *strMainNetDNSSeed[][2] = {
    {"magicinternetmoney.org", "dnsseed.magicinternetmoney.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"magicinternetmoneycoin.org", "test-dnsseed.magicinternetmoneycoin.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. MagicInternetMoney is probably already running."), addrBind.ToString().c_str());
        else
