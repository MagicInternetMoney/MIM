...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("MagicInternetMoney version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  magicinternetmoneyd [options]                     " + "\n" +
                  "  magicinternetmoneyd [options] <command> [params]  " + _("Send command to -server or magicinternetmoneyd") + "\n" +
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: magicinternetmoney.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: magicinternetmoneyd.pid)") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 9791 or testnet: 19791)") + "\n" +
        ...
        "\n" + _("SSL options: (see the MagicInternetMoney Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. MagicInternetMoney is probably already running."), strDataDir.c_str()));

    if (GetBoolArg("-shrinkdebugfile", !fDebug))
        ShrinkDebugFile();
    printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    printf("MagicInternetMoney version %s (%s)\n", FormatFullVersion().c_str(), CLIENT_DATE.c_str());
